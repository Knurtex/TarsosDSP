...
public class MicrophoneInputPanel extends JPanel {
		...
		public void actionPerformed(ActionEvent arg0) {
			for(Mixer.Info info : Shared.getMixerInfo(false, true)){
				if(arg0.getActionCommand().equals(info.toString())){
					...
					MicrophoneInputPanel.this.firePropertyChange("mixer", mixer, newValue);
					MicrophoneInputPanel.this.mixer = newValue;
					break;
				}
			}
		}
