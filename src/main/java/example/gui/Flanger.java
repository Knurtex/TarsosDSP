...
import dsp.io.jvm.WaveformWriter;
...
public class Flanger extends JFrame {
	...
	private JPanel buildInputPanel() {
		...
		fileChooserPanel.setBorder(new TitledBorder("1... Or choose your audio"));
	...
	private void startFile(File inputFile, Mixer mixer) {
		...
		try {
			...
			final WaveformWriter wavWriter;
			
			 if(inputFile == null){
				 AudioFormat format = new AudioFormat((float) sampleRate, 16, 1, true,true);
				 audioPlayer = new AudioPlayer(format);
				 wavWriter = new WaveformWriter(format, "flanger.wav");
				...
				dispatcher = new AudioDispatcher(audioStream, bufferSize,overlap); 
				 ...
				 dispatcher = AudioDispatcherFactory.fromPipe(inputFile.getAbsolutePath(),44100 ,bufferSize ,overlap);
	...
	public static class FlangerStarter extends TarsosDSPExampleStarter {

		@Override
		public String name() {
			return "Flanger effect";
		}

		@Override
		public String description(){
			return "Applies a flanger effect to audio.";
		}
