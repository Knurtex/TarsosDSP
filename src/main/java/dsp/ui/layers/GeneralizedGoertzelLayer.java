...
import dsp.pitch.GeneralizedGoertzel;
import dsp.pitch.Goertzel;
import dsp.pitch.Goertzel.FrequenciesDetectedHandler;
import dsp.ui.Axis;
...
public class GeneralizedGoertzelLayer implements Layer{
	...
	public void calculateFeatures() {
		try {
          ...
          goertzel = new GeneralizedGoertzel(sampleRate,blockSize,frequencies,handler);
