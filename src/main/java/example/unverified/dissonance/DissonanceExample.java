...
package example.unverified.dissonance;
...
import dsp.SpectralPeakProcessor;
import dsp.SpectralPeakProcessor.SpectralPeak;
import dsp.io.PipeDecoder;
import dsp.io.PipedAudioStream;
import dsp.io.TarsosDSPAudioInputStream;
...
import dsp.ui.layers.HorizontalFrequencyAxisLayer;
import dsp.ui.layers.Layer;
import dsp.ui.layers.SelectionLayer;
import dsp.ui.layers.SpectrumLayer;
import dsp.ui.layers.ZoomMouseListenerLayer;
import dsp.ui.layers.pch.ScaleLayer;
import dsp.util.PitchConverter;
import example.unverified.dissonance.spectrum.SpectralInfo;
...
public class DissonanceExample extends JFrame {
	...
	private Component createButtonPanel(String startDir) {
		...
		Integer min =  Integer.valueOf(32);
		Integer max =  Integer.valueOf(131072);
		Integer step =  Integer.valueOf(32);
	...
	private JPanel createSpectrumPanel(){
		CoordinateSystem
        cs =  new CoordinateSystem(AxisUnit.FREQUENCY, AxisUnit.AMPLITUDE, -1000, 10, false);
	...
	private void extractPeakListList() throws UnsupportedAudioFileException, LineUnavailableException{
		...
		player.addAudioProcessor(new AudioPlayer(
        JVMAudioInputStream.toAudioFormat(PipeDecoder.getTargetAudioFormat(sampleRate))));
	...
	private void writeSpectralInfoToFile() throws IOException{
		...
		KernelDensityEstimate.Kernel kernel = new KernelDensityEstimate.GaussianKernel(80);
