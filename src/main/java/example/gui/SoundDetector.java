...
public class SoundDetector extends JFrame implements AudioProcessor {
	...
	public static class SoundDetectorStarter extends TarsosDSPExampleStarter {

		@Override
		public String name() {
			return "Sound detector";
		}

		@Override
		public String description(){
			return "Shows how to react on loud events";
		}

		@Override
		public void start(String... args) {
			try {
				SoundDetector.main(args);
