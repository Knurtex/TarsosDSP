...
@Override
		...
		try {
			...
			//can not time travel, unfortunately. It would be nice to go back and kill Hitler or something...
             ...
             WaveformSimilarityBasedOverlapAdd.Parameters.musicDefaults(currentFactor, sampleRate));
				 ...
				 wsola = new WaveformSimilarityBasedOverlapAdd(
             WaveformSimilarityBasedOverlapAdd.Parameters.musicDefaults(1, sampleRate));
			 }
			 if(inputFile == null){
	...
	private static void startCli(String source,String target,double cents) throws UnsupportedAudioFileException, IOException{
        ...
        WaveformSimilarityBasedOverlapAdd.Parameters.musicDefaults(factor, sampleRate));
